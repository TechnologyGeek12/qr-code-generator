...
export function QRGenerator(props) {
    // console.log('data aaya',backgroundColor,foregroundColor,width,height,qrLogo,customDesign,value);
    ...
    var isLogo = false;
    var logoSize = 80;
    var customLogoDesign = false;
    var value = 'https://github.com/TechnologyGeek12';
    if (props) {
        backgroundColor = props.backgroundColor ? props.backgroundColor : '#fff';
        foregroundColor = props.foregroundColor ? props.foregroundColor : '#000';
        width = props.width ? props.width : 256;
        height = props.height ? props.height : 256;
        isLogo = props.isLogo ? props.isLogo : false;
        logoSize = props.logoSize ? props.logoSize : 80;
        customLogoDesign = props.customLogoDesign ? props.customLogoDesign : false;
        value = props.value ? props.value : 'https://github.com/TechnologyGeek12';
    }
    ...
    var val = value;
    if (val) {
        $("#qr-container").empty(); //to replace previous one and generate new
        $('#qr-container').qrcode(val);
        if ($('#qr-container').height() && $('#qr-logo-image') && isLogo) {
            $('#qr-logo-image').css("display", "unset");
            $('#qr-logo-image').css("position", "absolute");
            $('#qr-logo-image').css("width", logoSize);
            $('#qr-logo-image').css("top", $('#QRCanvas').position().top + ((height / 2) - (logoSize / 2 + 5)));
            $('#qr-logo-image').css("left", $('#QRCanvas').position().left + ((width / 2) - (logoSize / 2 + 5)));
            if (!customLogoDesign) {
                $('#qr-logo-image').css("background-color", '#fff');
                $('#qr-logo-image').css("border", '3px solid white');
            }
        }
    } else {
